...
type Config struct {
	...
	MySQLDataSource          string `env:"MYSQL_DATA_SOURCE" envDefault:"root:root@tcp(127.0.0.1:3366)/dispute_explorer_migrate?charset=utf8mb4&parseTime=True&loc=Local&multiStatements=true"`
